        ...
        <div className="max-w-3xl mx-auto px-4 pt-6">
           ...
           <div className="space-y-8">
              {menuSections.map((section, idx) => (
                 <div key={idx}>
                    <h3 className="font-headline font-bold text-sm text-zinc-500 uppercase tracking-widest mb-4 ml-2">{section.title}</h3>
           ...
           <div className="mt-8 pt-4">
              <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 p-5 bg-red-50 text-red-600 rounded-3xl font-headline font-extrabold uppercase tracking-widest text-sm hover:bg-red-100 transition-colors border border-red-100 active:scale-95 shadow-sm">
