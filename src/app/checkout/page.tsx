...
export default function CheckoutPage() {
 ...
 clearCart();
 router.push(`/orders`); } catch (error: any) {
 ...
 className="absolute bottom-1 right-1 bg-white border border-green-600 text-green-600 text-[8px] font-black px-2 py-0.5 rounded shadow-sm "
 >
 ADD
 </button>
 </div>
 ...
 <h3 className="text-[10px] font-black tracking-widest text-zinc-900 mb-4 font-headline">Select Delivery Slot</h3>
 ...
 {/* Bill Details */}
 <section className="bg-white rounded-3xl p-6 shadow-sm border border-zinc-100">
 <h3 className="text-[10px] font-black tracking-widest text-zinc-400 mb-6 font-headline">Bill details</h3>
 <div className="space-y-4">
 <div className="flex justify-between items-center text-[11px] font-bold text-zinc-600">
 <div className="flex items-center gap-2">
 <span className="material-symbols-outlined text-sm">sticky_note_2</span>
 <span className="tracking-widest">Items total</span>
 </div>
 ...
 <span className="tracking-widest">Delivery charge</span>
 </div>
 ...
 <p className="text-[7px] font-black text-orange-500 tracking-widest ml-7">Free on orders above ₹{settings.freeDeliveryThreshold}</p>
 )}
 </div>
 ...
 <p className="text-[7px] font-black text-orange-500 tracking-widest ml-7">Applicable on orders below ₹{settings?.smallCartThreshold || 100}</p>
 </div>
 )}
 ...
 <section className="bg-white rounded-3xl p-6 shadow-sm border border-zinc-100">
 <h3 className="text-[10px] font-black tracking-widest text-zinc-900 mb-6 font-headline">Payment Mode</h3>
 ...
 <p className="text-[9px] font-bold text-zinc-400 tracking-widest">Pay at your doorstep</p>
 </div>
 </div>
 ...
 <section className="bg-white rounded-3xl p-6 shadow-sm border border-zinc-100">
 <h3 className="text-[10px] font-black tracking-widest text-zinc-900 mb-6 font-headline">Delivery Instructions</h3>
 ...
 <p className="text-[9px] font-black text-zinc-900 tracking-widest mb-1">Cancellation Policy</p>
 ...
 <p className="text-[10px] font-black text-zinc-900 ">{selectedSlot ?`Deliver ${selectedSlot.split('')[0]}`: 'Set Slot'}</p>
 </div>
 ...
 <span className="text-[8px] font-bold tracking-widest opacity-80">TOTAL</span>
 </div>
 <div className="flex items-center gap-2">
 <span className="text-[14px] font-black tracking-widest">{placingOrder ? 'Processing...': 'Place Order'}</span>
