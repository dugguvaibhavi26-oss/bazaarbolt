...
function LoginContent() {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      try {
        ...
        // If popup is blocked or fails (COOP issue), try redirect instantly
        if (
 ...
 <p className="mt-2 text-sm font-bold text-zinc-500 tracking-widest">Just a few more details</p>
 </div>
 ...
 <div>
 <label className="block text-[11px] font-bold text-zinc-500 tracking-widest mb-2 ml-1">Full Name</label>
 <input
 type="text"
 required
 ...
 <div>
 <label className="block text-[11px] font-bold text-zinc-500 tracking-widest mb-2 ml-1">Phone Number</label>
 <input
 type="tel"
 required
 className="appearance-none block w-full px-4 py-3.5 bg-zinc-50 border border-zinc-100 rounded-xl text-zinc-900 font-medium placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white transition-all text-sm"
 ...
 type="submit"
 disabled={loading}
 className="w-full flex justify-center items-center gap-2 py-4 px-4 border border-transparent rounded-xl shadow-xl text-sm font-black text-zinc-900 bg-primary hover:bg-green-500 focus:outline-none disabled:opacity-50 active:scale-95 transition-all tracking-widest"
 >
 ...
 <p className="mt-2 text-sm font-bold text-zinc-500 tracking-wider ">
 ...
 <div>
 <label className="block text-[11px] font-bold text-zinc-500 tracking-widest mb-2 ml-1">Email address</label>
 <div className="mt-1 relative">
 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
 ...
 <div>
 <label className="block text-[11px] font-bold text-zinc-500 tracking-widest mb-2 ml-1">Password</label>
 <div className="mt-1 relative">
 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
 ...
 type="submit"
 disabled={loading}
 className="w-full flex justify-center items-center gap-2 py-4 px-4 border border-transparent rounded-xl shadow-[0_8px_16px_-4px_rgba(34,197,94,0.4)] text-sm font-black text-zinc-900 bg-primary hover:bg-green-500 focus:outline-none disabled:opacity-50 active:scale-95 transition-all tracking-widest"
 >
 ...
 <span className="text-[10px] font-bold text-zinc-400 tracking-widest">or</span>
 <div className="flex-1 h-[1px] bg-surface-variant"></div>
 </div>
