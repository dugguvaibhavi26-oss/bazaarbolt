                            ...
                            <div className="relative z-10 flex flex-col h-full">
                               ...
                               <div className="mb-6">
                                  <div className="flex items-baseline gap-1">
                                     ...
                                     <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">/{plan.interval || 'month'}</span>
                                  </div>
                               </div>
                               ...
                               <button onClick={() => handleSubscribe(plan.id)} className={`w-full py-4 rounded-2xl font-black uppercase tracking-widest text-sm transition-all active:scale-95 shadow-md ${isGold ? 'bg-zinc-900 hover:bg-black text-white' : 'bg-blue-100 hover:bg-blue-200 text-blue-900'}`}>
                                  Get {plan.name}
                               </button>
                            </div>
                         </div>
