             ...
             filteredOrders.map((order) => (
               ...
               >
                  ...
                  {order.riderId === user?.uid && (
                     <div className="absolute top-0 right-16 bg-primary text-zinc-900 px-4 py-1 rounded-b-xl font-black text-[8px] uppercase tracking-widest shadow-md">Assigned Job</div>
                  )}
               </Link>
             ))
           )}
