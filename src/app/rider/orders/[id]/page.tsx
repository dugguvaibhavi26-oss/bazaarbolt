...
export default function RiderOrderDetail() {
 ...
 <div>
 <p className="text-[10px] font-black text-primary tracking-widest mb-1">Order Status</p>
 <h3 className="text-2xl font-headline font-black tracking-tight">{order.status.replace("_", "")}</h3>
 </div>
 <div className="text-right">
 <p className="text-[10px] font-black text-zinc-500 tracking-widest mb-1">Grand Total</p>
 ...
 <div className="flex justify-between items-center opacity-60">
 <span className="text-[9px] font-black tracking-widest">Taxes</span>
 <span className="text-[11px] font-bold">₹{order.tax.toFixed(2)}</span>
 </div>
 {(order.total - order.subtotal - order.tax) > 0 && (
 <div className="flex justify-between items-center opacity-60">
 <span className="text-[9px] font-black tracking-widest">Service & Delivery</span>
 ...
 <p className="text-[10px] font-black text-zinc-400 tracking-widest mb-1">Customer</p>
 ...
 <div>
 <p className="text-[10px] font-black text-zinc-400 tracking-widest mb-1">Delivery Address</p>
 ...
 <h3 className="text-[10px] font-black text-zinc-900 tracking-widest mb-4">Shipment Checklist</h3>
 ...
 <p className="text-[9px] font-bold text-zinc-400 tracking-widest">Quantity: {item.quantity}</p>
 </div>
 </div>
 <div className="text-right">
 ...
 disabled={processing}
 className={`w-full py-2 rounded-xl text-[9px] font-black tracking-widest transition-all ${
 ...
 disabled={processing}
 className="w-full h-14 bg-zinc-900 text-white rounded-2xl font-headline font-black text-xs tracking-widest shadow-xl active:scale-95 transition-all"
 >
 ...
 disabled={processing}
 className="w-full h-14 bg-primary text-zinc-900 rounded-2xl font-headline font-black text-xs tracking-widest shadow-xl active:scale-95 transition-all"
 >
 ...
 <p className="text-[10px] font-black text-zinc-500 tracking-widest text-center">Enter Customer PIN</p>
 <div className="flex gap-3">
 ...
 <button onClick={() => setIsVerifying(false)} className="w-full text-[10px] font-black text-zinc-500 tracking-widest py-2">Cancel</button>
 </div>
 ) : (
