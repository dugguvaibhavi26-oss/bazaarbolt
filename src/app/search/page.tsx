...
export default function SearchPage() {
  ...
  // Generate recommendations based on cart or just random/top products
  ...
  return (
    <div className="bg-white min-h-screen relative overflow-x-hidden pb-10 text-zinc-900 font-body selection:bg-primary/30">
      ...
      <header className="sticky top-0 z-50 bg-white pt-4 pb-4 px-4 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border-b border-zinc-100">
         <div className="flex items-center gap-3 bg-zinc-100 rounded-2xl px-4 py-3 shadow-inner border border-zinc-200 focus-within:bg-white focus-within:border-primary transition-all">
           ...
           <input
             ...
             className="bg-transparent border-none outline-none w-full text-xs font-black tracking-widest placeholder:text-zinc-400 text-zinc-900"
           />
           {searchTerm && (
      ...
      <main className="px-4 mt-6">
        {searchStr === '' ? (
          <div className="animate-in fade-in duration-300">
            {/* Recommendations Section (Search Pills) */}
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-headline font-black text-sm text-zinc-400 tracking-widest uppercase">Recommendations</h3>
            </div>
              ...
              <div className="flex flex-wrap gap-2 mb-10">
                {recentSearches.map((item, i) => (
                  <button 
                    ...
                    className="pl-2 pr-4 py-2 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold text-zinc-700 hover:bg-zinc-100 transition-colors flex items-center gap-2 shadow-sm"
                  >
            ...
            <h3 className="font-headline font-black text-sm text-zinc-400 tracking-widest uppercase mb-4">Top picks for you</h3>
          ...
          <div className="animate-in fade-in duration-300">
            <h3 className="font-headline font-black text-xs text-zinc-400 mb-4 tracking-widest uppercase">{filteredProducts.length} Results for "{searchTerm}"</h3>
      ...
      {/* Global Bottom Banner Ad for Search Route */}
      <div className="px-4 mt-12 mb-8">
        <AdUnit slotId="search-bottom-banner" />
      </div>
