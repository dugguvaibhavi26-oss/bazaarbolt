    ...
    <div className="p-6 max-w-4xl mx-auto pb-40">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Taxes (GST %)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Platform Handling Fee (₹)</label>
                <input
                  type="number"
          ...
          <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Delivery Fee (₹)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Threshold for FREE (₹)</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Small Cart Fee (₹)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-[10px] font-black uppercase text-zinc-500 mb-1 block">Threshold for Small Fee (₹)</label>
                  <input
                    type="number"
              ...
              {form.customCharges.map((charge, idx) => (
                <div key={idx} className="flex gap-2 items-end">
                  <div className="flex-1">
                    <label className="text-[9px] font-black text-zinc-400 uppercase mb-1 block">Title (e.g. Bag Charge)</label>
                    <input
                      type="text"
                      value={charge.label}
                  ...
                  <div className="w-24">
                    <label className="text-[9px] font-black text-zinc-400 uppercase mb-1 block">Amount (₹)</label>
                    <input
                      type="number"
                      value={charge.amount}
      ...
      <div className="fixed bottom-10 left-1/2 -translate-x-1/2 w-full max-w-sm px-6">
        <button
          ...
          disabled={loading}
          className="w-full bg-zinc-900 text-white h-16 rounded-3xl font-black uppercase tracking-widest text-xs shadow-2xl active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
        >
