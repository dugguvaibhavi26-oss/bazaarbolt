    ...
    <div className="space-y-8">
       <div className="flex items-center justify-between">
          <div>
             ...
             <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mt-1">Configure premium tiers and pricing</p>
          </div>
          <button onClick={() => toast("Feature coming soon: Plan Creator")} className="bg-zinc-900 text-white px-6 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-black shadow-lg">
                ...
                <div key={plan.id} className={`p-1 rounded-[40px] ${isGold ? 'bg-gradient-to-br from-yellow-100 to-yellow-500' : 'bg-gradient-to-br from-blue-100 to-blue-500'} shadow-lg`}>
                   <div className="bg-white rounded-[39px] p-8 h-full relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-start mb-8 relative z-10">
                         <div>
                            <span className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-3 ${isGold ? 'bg-yellow-100 text-yellow-700' : 'bg-blue-100 text-blue-700'}`}>
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-zinc-100">
                         <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">{plan.active ? 'Visible To Users' : 'Hidden'}</span>
                         </div>
                         <div className="flex gap-2">
                            ...
                            <button 
                              ...
                              className={`px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${plan.active ? 'bg-red-50 text-red-600' : 'bg-green-50 text-green-600'}`}
                            >
