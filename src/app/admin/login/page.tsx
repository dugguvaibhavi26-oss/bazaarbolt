...
export default function AdminLoginPage() {
 ...
 <h1 className="text-3xl font-headline font-black text-white tracking-tight ">Security Vault</h1>
 <p className="text-[10px] font-black text-zinc-500 tracking-[0.3em] mt-2">BazaarBolt Admin Infrastructure</p>
 </div>

 <form onSubmit={handleLogin} className="space-y-6">
 <div>
 <label className="text-[10px] font-black tracking-widest text-zinc-500 ml-1 mb-2 block">Personnel Identifier (Email)</label>
 ...
 <div>
 <label className="text-[10px] font-black tracking-widest text-zinc-500 ml-1 mb-2 block">Security Token (Password)</label>
 ...
 <div className="pt-4">
 <button type="submit"className="w-full bg-primary hover:bg-white text-zinc-900 h-16 rounded-2xl font-headline font-black text-xs tracking-widest transition-all shadow-xl shadow-primary/10 active:scale-95">
