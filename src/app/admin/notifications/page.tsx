  ...
  return (
    <div className="space-y-8 pb-32">
      <div>
        ...
        <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mt-1">Send real-time alerts to users</p>
      </div>
      ...
      <div className="bg-white rounded-[40px] shadow-sm border border-zinc-100 p-8 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div>
              <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-1 mb-2 block">Target Audience</label>
            ...
            <div>
              <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-1 mb-2 block">Notification Title</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-1 mb-2 block">Message Content</label>
              <textarea
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-zinc-900 text-white py-5 rounded-3xl font-black uppercase tracking-widest text-[10px] transition-all hover:bg-black shadow-xl shadow-zinc-900/10 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
        <div className="bg-blue-50/50 p-6 rounded-3xl border border-blue-100">
          <p className="text-[10px] font-black text-blue-600 uppercase mb-2">Pro Tip</p>
