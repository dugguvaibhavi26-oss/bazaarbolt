                   ...
                   <div>
                      ...
                      <div className="flex gap-1 mt-2">
                        <button 
                          ...
                          className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest transition-all ${uploadMode === 'manual' ? 'bg-zinc-900 text-white' : 'bg-zinc-100 text-zinc-400'}`}
                        >
                          Manual Entry
                        </button>
                        <button 
                          onClick={() => setUploadMode("bulk")}
                          className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest transition-all ${uploadMode === 'bulk' ? 'bg-zinc-900 text-white' : 'bg-zinc-100 text-zinc-400'}`}
                        >
                          Bulk Upload
                        </button>
                      </div>
                ...
                {uploadMode === "manual" ? (
                   ...
                   <div className="space-y-6">
                      <div className="p-8 border-2 border-dashed border-zinc-200 rounded-[32px] bg-zinc-50 flex flex-col items-center justify-center text-center group hover:border-primary transition-all relative cursor-pointer">
                         ...
                         <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Supports CSV and Excel files</p>
                      </div>
                      ...
                      <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
                         <div className="flex items-center gap-3">
                            ...
                            <div>
                               <p className="text-[10px] font-black text-zinc-900 uppercase">Need a template?</p>
                         ...
                         <button 
                           ...
                           className="bg-white border border-zinc-200 px-4 py-2 rounded-xl text-[8px] font-black uppercase tracking-widest hover:bg-zinc-50 transition-all flex items-center gap-2"
                         >
                      ...
                      {previewData.length > 0 && (
                         <div className="space-y-3">
                            <div className="flex items-center justify-between px-1">
                               <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Preview ({previewData.length} valid rows)</span>
                               {uploadStats.failed > 0 && (
                                  <span className="text-[10px] font-black uppercase tracking-widest text-red-500">{uploadStats.failed} invalid rows skipped</span>
                               )}
                            </div>
                            <div className="bg-zinc-50 rounded-2xl overflow-hidden border border-zinc-100 max-h-[180px] overflow-y-auto">
                               <table className="w-full text-left border-collapse">
                                  <thead className="bg-zinc-100 sticky top-0">
                                     <tr>
                                        <th className="p-3 text-[8px] font-black uppercase tracking-widest text-zinc-500">Product</th>
                                        <th className="p-3 text-[8px] font-black uppercase tracking-widest text-zinc-500">Category</th>
                                        <th className="p-3 text-[8px] font-black uppercase tracking-widest text-zinc-500 text-right">Price</th>
                                     </tr>
                                  </thead>
                                  <tbody className="divide-y divide-zinc-100">
                                     {previewData.slice(0, 5).map((p, i) => (
                                        <tr key={i} className="hover:bg-zinc-100/50">
                                           ...
                                           <td className="p-3">
                                              <span className="text-[8px] font-black text-zinc-500 uppercase">{p.category}</span>
                                           </td>
                                     ...
                                     {previewData.length > 5 && (
                                        <tr>
                                           <td colSpan={3} className="p-2 text-center text-[8px] font-black text-zinc-400 uppercase tracking-widest">
                      ...
                      <div className="flex gap-4 pt-6">
                         <button 
                           ...
                           className="flex-1 bg-zinc-100 text-zinc-500 py-5 rounded-3xl font-black uppercase tracking-widest text-[10px] transition-all hover:bg-zinc-200"
                         >
                            Cancel
                         </button>
                         <button 
                           ...
                           className={`flex-1 py-5 rounded-3xl font-black uppercase tracking-widest text-[10px] transition-all shadow-xl shadow-zinc-900/10 flex items-center justify-center gap-2
