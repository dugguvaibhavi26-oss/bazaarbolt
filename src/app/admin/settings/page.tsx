...
export default function AdminSettings() {
 ...
 <p className="text-xs font-bold text-zinc-400 tracking-widest mt-1">Control global store parameters</p>
 </div>
 <button onClick={handleSave} disabled={saving}
 className="bg-zinc-900 text-white px-8 py-4 rounded-2xl font-black text-[10px] tracking-widest flex items-center gap-2 hover:bg-black shadow-xl active:scale-95 disabled:opacity-50 transition-all"
 >
 ...
 <p className="text-[10px] font-bold text-zinc-500 tracking-widest">Enables/Disables all customer checkouts</p>
 </div>
 ...
 <div>
 <label className="text-[10px] font-black tracking-widest text-zinc-400 ml-1 mb-2 block">Announcement Bar Content</label>
 ...
 <div>
 <label className="text-[10px] font-black tracking-widest text-zinc-400 ml-1 mb-2 block">Global Tax Rate (%)</label>
 <input type="number"value={settings.taxPercent}
 ...
 <div>
 <label className="text-[10px] font-black tracking-widest text-zinc-400 ml-1 mb-2 block">Hero Banner Decoration URL</label>
 <input type="text"value={settings.bannerImage}
 ...
 <span className="text-white font-black text-[10px] tracking-widest">Banner Active</span>
 </div>
 </div>
 )}
 </div>
 ...
 <div>
 <label className="text-[9px] font-black tracking-widest text-zinc-500 mb-2 block">Primary Identity Color</label>
 ...
 <p className="text-[9px] font-bold text-zinc-500 tracking-widest leading-relaxed">Changes to identity color will affect buttons, status indicators, and highlights across the customer app.</p>
 </div>
 </div>
 </div>

 <div className="bg-white rounded-[40px] p-8 border border-zinc-100 shadow-sm">
 <h4 className="font-headline font-black text-sm tracking-widest text-zinc-400 mb-4">Payment Control</h4>
 <div className="flex items-center justify-between">
