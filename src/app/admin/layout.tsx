...
`}>
 ...
 <span className="text-[9px] font-bold text-zinc-500 tracking-widest">Master Access</span>
 </div>
 </div>
 </div>
 <button onClick={() => {
 ...
 <h2 className="text-lg font-headline font-black text-zinc-900 tracking-tight ">
 ...
 <span className="text-[10px] font-black text-zinc-500 tracking-widest">Server: Live</span>
 </div>
