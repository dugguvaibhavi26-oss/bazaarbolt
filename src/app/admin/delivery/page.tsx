...
export default function AdminDelivery() {
 ...
 <div>
 <h2 className="text-4xl font-headline font-black text-zinc-900 tracking-tighter ">Delivery Configuration</h2>
 <p className="text-[10px] font-black text-zinc-400 tracking-widest mt-1">Manage scheduling and capacity controls</p>
 </div>
 ...
 <span className="text-[10px] font-black text-zinc-900 tracking-widest">{slots.length} Active Slots</span>
 </div>
 </header>
 ...
 <h3 className="text-xs font-black text-zinc-900 tracking-widest">Add New Slot</h3>
 <div className="space-y-4">
 <div className="space-y-2">
 <label className="text-[10px] font-black text-zinc-400 tracking-widest ml-1">Slot Label</label>
 ...
 className="w-full bg-zinc-900 text-white h-16 rounded-2xl font-black tracking-widest text-[10px] hover:bg-black transition-all shadow-xl shadow-zinc-900/10 active:scale-95 flex items-center justify-center gap-2"
 >
 ...
 <h3 className="text-xl font-headline font-black text-zinc-900 ">Active Schedule</h3>
 <span className="text-[10px] font-black text-zinc-400 tracking-widest">Sequence: Creation Order</span>
 </div>

 {slots.length === 0 ? (
 <div className="flex flex-col items-center justify-center py-20 text-zinc-300">
 <span className="material-symbols-outlined text-6xl mb-4">event_busy</span>
 <p className="text-[10px] font-black tracking-widest">No slots configured</p>
 </div>
 ) : (
 ...
 <p className="text-sm font-black text-zinc-900 tracking-tight">{slot}</p>
 </div>
