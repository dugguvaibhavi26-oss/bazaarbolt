...
export default function Home() {
 ...
 <h2 className="text-5xl md:text-7xl font-headline font-black text-zinc-900 tracking-tighter leading-[0.8] mb-8">
 Currently <br />
 ...
 <span className="text-[10px] font-black text-zinc-900 tracking-widest">{item.label}</span>
 </div>
 ...
 <h2 className="font-headline font-black text-3xl text-zinc-900 tracking-tighter mb-4 opacity-60">
 ...
 <p className="font-black text-zinc-900 tracking-[0.4em] opacity-30">
 BAZAARBOLT
 </p>
 ...
 <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth"})} className="flex flex-col items-center justify-center text-zinc-900 group active:scale-95 transition-transform">
 ...
 <span className="font-headline text-[8px] font-black tracking-widest mt-0.5 text-zinc-900">Home</span>
 </button>

 <button onClick={() => router.push('/search')} className="flex flex-col items-center justify-center text-zinc-400 hover:text-zinc-900 group active:scale-95 transition-all">
 <span className="material-symbols-outlined text-[20px] group-hover:scale-110 transition-transform">search</span>
 <span className="font-headline text-[8px] font-black tracking-widest mt-0.5 text-zinc-400 group-hover:text-zinc-900">Search</span>
 </button>
 ...
 <span className="font-headline text-[8px] font-black tracking-widest mt-0.5 text-zinc-400 group-hover:text-zinc-900">Cart</span>
 </button>
 </nav>
