          ...
          <>
            ...
            {[
              ...
              ...categories.map(cat => ({
                ...
                products: products.filter(p => p.category === cat.id || p.category === cat.label).slice(0, 12),
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input type="text" placeholder="e.g. Noida" className="w-full bg-zinc-50 border-none rounded-2xl p-4 font-bold text-sm focus:ring-4 ring-primary/20 transition-all" value={addressForm.city} onChange={e => setAddressForm({ ...addressForm, city: e.target.value })} />
                  </div>
                  <div className="space-y-1.5">
