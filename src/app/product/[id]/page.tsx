    ...
    <main className="min-h-screen bg-zinc-50 pb-40">
       ...
       <section className="bg-white px-5 py-6 rounded-b-[32px] shadow-sm border-b border-zinc-100">
          <div className="flex items-start justify-between gap-4 mb-3">
             <div className="flex-1">
                ...
                <p className="text-sm font-bold text-zinc-400 mt-1 uppercase tracking-tight">Net quantity: 1 unit</p>
             </div>
          ...
          <div className="mt-6 flex flex-col gap-1">
             ...
             <p className="text-[9px] font-bold text-zinc-400 uppercase mt-1">(incl. of all taxes)</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-zinc-50 rounded-2xl border border-zinc-100 flex items-center justify-between group active:bg-zinc-100 transition-colors">
             <div className="flex items-center gap-3">
                ...
                <p className="text-xs font-black text-zinc-800 uppercase tracking-tight">View all {product.category} products</p>
             </div>
       ...
       <section className="mt-3 px-5 space-y-3">
          <div className="bg-white p-6 rounded-3xl border border-zinc-100">
             <h3 className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-4">Product Details</h3>
          ...
          <div className="bg-white p-6 rounded-3xl border border-zinc-100">
             <h3 className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-6">Why shop from BazaarBolt?</h3>
          ...
          <div className="max-w-2xl mx-auto flex items-center gap-4">
             {!cartItem ? (
                <button 
                  ...
                  className="flex-1 h-12 bg-primary hover:bg-green-600 text-zinc-900 rounded-xl font-black uppercase text-[11px] tracking-widest shadow-lg shadow-primary/20 active:scale-95 transition-all disabled:opacity-50 disabled:bg-zinc-200 disabled:text-zinc-500 disabled:shadow-none"
                >
                ...
                <div className="w-full flex items-center gap-4">
                   <div className="flex-1 h-12 bg-zinc-900 text-white rounded-xl flex items-center justify-between px-2 overflow-hidden shadow-xl">
                      ...
                      <div className="flex flex-col items-center">
                         ...
                         <span className="text-[7px] font-black uppercase text-zinc-500 mt-1">units in cart</span>
                      </div>
                      <button 
                        onClick={() => updateQuantity(product.id, 1)}
