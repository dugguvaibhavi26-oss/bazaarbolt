...
export default function OrderAgainPage() {
 ...
 <span className="text-[10px] font-bold text-zinc-400 tracking-widest mt-1">Based on your history</span>
 </div>
 </div>
 </header>
 ...
 <p className="font-headline font-black text-zinc-400 tracking-widest text-xs">No order history found</p>
 <button onClick={() => router.push("/")} className="mt-6 bg-zinc-900 text-white px-8 py-3 rounded-2xl font-black text-xs tracking-widest shadow-lg">Start Shopping</button>
 </div>
 ) : (
 <div className="grid grid-cols-2 gap-4">
 ...
 <div className="absolute top-2 right-2 bg-yellow-400 text-zinc-900 text-[8px] font-black px-2 py-1 rounded-full shadow-sm tracking-tighter">Frequently Bought</div>
 </div>
 ...
 <span className="font-headline text-[9px] font-black tracking-widest mt-1 text-zinc-900 font-black">Order Again</span>
 </button>
 ...
 <span className="font-headline text-[9px] font-black tracking-widest mt-1 text-zinc-400 group-hover:text-zinc-900">Support</span>
 </button>
