...
export class ErrorBoundary extends Component<Props, State> {
 ...
 <code className="text-[10px] font-black tracking-widest text-red-500 block text-left break-words">
 ...
 className="w-full flex items-center justify-center gap-2 bg-zinc-900 text-white px-6 py-4 rounded-2xl font-black tracking-widest text-xs hover:opacity-90 transition-all shadow-lg active:scale-95"
 >
 <span className="material-symbols-outlined text-sm">refresh</span> Reload Application
 </button>
 <Link href="/"onClick={() => this.setState({ hasError: false })} className="text-xs font-black tracking-widest text-on-surface-variant hover:text-primary transition-colors"
 >
 Reset & Return Home
 </Link>
 </div>
