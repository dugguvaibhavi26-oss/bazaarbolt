  ...
  const initPushNotifications = useCallback(async () => {
    ...
    try {
      ...
      PushNotifications.addListener('pushNotificationReceived', (notification: PushNotificationSchema) => {
        ...
        // We no longer show in-app toast popups here as per user request.
        // System-level notifications are handled by Capacitor presentationOptions in capacitor.config.ts
      });
